...
var StickyHeader = function () {
	function StickyHeader() {
		...
		this.siteHeader = (0, _jquery2.default)(".header-section");
...
var mobileMenu = function () {
	function mobileMenu() {
		...
		this.siteHeader = (0, _jquery2.default)('.header-section');
		this.menuIcon = (0, _jquery2.default)('.header-section__menu-icon');
		this.menuContent = (0, _jquery2.default)('.header-section__menu-content');
		this.events();
	}
...
var Modal = function () {
	...
	_createClass(Modal, [{
		...
		value: function events() {
			...
			// clicking the x button on modal
...
var onScroll = function () {
	function onScroll() {
		...
		this.itemsToReveal = (0, _jquery2.default)('.col-image, .generic-content-container');
		this.hideInitially();
...
var _onScroll = __webpack_require__(5);
...
var onScroll = new _onScroll2.default();
